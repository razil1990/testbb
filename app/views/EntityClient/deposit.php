...
<form class="row g-3" action="" method="POST">
  <?php require 'entity_data_form.php'?>
  <h3>Данные вклада</h3>
  <div class="col-12">
    ...
    <input type="range" class="form-range" id="depositSumRange" min="50000" max="200000" step="10000" value="<?= $deposit_sum ?? 50000 ?>">
  </div>
  <div class="col-12">
  ...
  <div class="col-12">
    <label for="depositDate" class="form-label">Дата открытия:</label>
...
<div class="info">
  ...
  <h2 id="capitalizationShow">Полная выплата по вкладу: <?= $capitalization ?></h2>
</div>
